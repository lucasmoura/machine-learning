...
class TestLinearRegression(unittest.TestCase):
    ...
    def createTrainingDataMock(self, x_array, y_array):
        ...
        type(trainingDataMock).y = PropertyMock(return_value=y_array)
    ...
    def testCalculateCost(self):
        ...
        actual_cost = self.linearRegression.calculateCost(trainingDataMock,
                                                          theta)
        expected_cost = 8.333
    ...
    def testCalculateGradient(self):
        ...
        gradient = self.linearRegression.calculateGradient(trainingDataMock,
                                                           theta)
